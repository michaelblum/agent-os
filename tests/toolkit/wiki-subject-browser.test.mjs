...
test('wiki subject browser exposes named shell manifest and semantic launch refs', async () => {
  ...
  assert.match(launch, /wiki-subject-browser-v0:subject-list:inspect:artifact-bundle-example-design-pass/);
  assert.match(launch, /wiki-subject-browser-v0:subject-list:open:artifact-bundle-example-design-pass/);
  assert.match(launch, /wiki-subject-browser-v0:subject-catalog:open:artifact-bundle-example-design-pass/);
