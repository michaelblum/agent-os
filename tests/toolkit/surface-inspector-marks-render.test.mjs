...
import { buildMarkLayers, renderMinimapMark, renderMarkListRow } from '../../packages/toolkit/components/surface-inspector/marks/render.js';
...
test('renderMinimapMark escapes id and name', () => {
  ...
  assert.match(svg, /data-aos-ref="surface-inspector:mark:canvas&quot;&lt;id:x&quot;&lt;y"/);
