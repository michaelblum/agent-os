...
test('renderCanvasRow stamps semantic metadata on DesktopWorld surface actions', () => {
  ...
  assert.match(html, /data-aos-ref="surface-inspector:canvas:desktop-world:stats"/)
  assert.match(html, /data-aos-ref="surface-inspector:canvas:desktop-world:tint"[^>]*aria-pressed="true"/)
  assert.match(html, /data-aos-ref="surface-inspector:canvas:desktop-world:remove"/)
})
...
test('canvas action attrs escape hostile canvas identifiers', () => {
  ...
  assert.match(html, /data-aos-ref="surface-inspector:canvas:&lt;avatar&gt;:stats"/)
...
test('inspector control attrs expose pressed and expanded states', () => {
  ...
  assert.match(pressed, /data-aos-ref="surface-inspector:control:minimap-cursor"/)
