...
test('experience runtime context v1 schema accepts a healthy status envelope', async () => {
  ...
  assert.equal(payload.schema_version, 'aos.experience-runtime-context.v1');
