...
const schemaPath = path.join(repoRoot, 'shared/schemas/aos-dock-provenance-ledger-v0.schema.json');
const fixtureRoot = path.join(repoRoot, 'shared/schemas/fixtures/aos-dock-provenance-ledger');
...
test('valid provenance ledger fixtures match the canonical schema', async () => {
...
test('invalid provenance ledger fixtures are rejected by the canonical schema', async () => {
