...
PREFIX="aos-log-command-preflight"
...
printf 'hello\n' | run_against_mock "stream" ./aos log --level info
run_against_mock "push" ./aos log push "hello" --level info
run_against_mock "clear" ./aos log clear
...
expected = [
    ("system.preflight aos log", "show.create"),
    ("system.preflight aos log push", "show.post"),
    ("system.preflight aos log clear", "show.post"),
]
cursor = 0
...
echo "PASS: log commands preflight projection capabilities before IPC"
echo "PASS"
