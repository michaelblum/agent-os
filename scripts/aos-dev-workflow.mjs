...
function auditRegistryClaims(repoRoot) {
  ...
  return [
    ...
    auditFormFlagClaim('dev-agents-help-flags', forms.get('dev-agents'), ['--self-test', '--list-runs', '--read-run', '--role', '--task', '--execute', '--patch-output', '--context-file', '--max-turns', '--repo', '--json'], false),
