...
function auditRegistryClaims(repoRoot) {
  ...
  return [
    ...
    auditFormFlagClaim('dev-agents-help-flags', forms.get('dev-agents'), ['--self-test', '--list-runs', '--read-run', '--check-patch', '--apply-patch', '--i-approve-checkout-mutation', '--role', '--task', '--execute', '--patch-output', '--context-file', '--max-turns', '--repo', '--json'], false),
