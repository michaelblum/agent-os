...
func listCommand() {
    let displays = getDisplays()
    let result = enumerateWindows(displays: displays)
    ...
    let topology = SpatialTopology(
        ...
        cursor: stCursor,
        focused_window_id: result.focusedWindowID,
        focused_app: result.focusedApp,
...
struct SideEye {
    static func main() {
        ...
        case "serve":
            ...
            // serveCommand() never returns (it runs dispatchMain)
        ...
        case "focus":
            ...
            case "update":  focusUpdateCommand(args: rest)
