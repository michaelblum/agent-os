...
export const WORK_RECORD_REPAIR_BUNDLE_SCHEMA_VERSION = '2026-08-work-record-repair-recovery-bundle-v1';
export const WORK_RECORD_REPAIR_BUNDLE_IMPLEMENTATION_VERSION = '2026-08-work-record-repair-bundle-v1';
...
export const WORK_RECORD_REPAIR_BUNDLE_INSPECTION_SCHEMA_VERSION = '2026-08-work-record-repair-recovery-bundle-inspection-v1';

export const WORK_RECORD_REPAIR_BUNDLE_LIFECYCLE_STATUS_TYPE = 'work_record.repair_recovery_bundle_lifecycle_status';
export const WORK_RECORD_REPAIR_BUNDLE_LIFECYCLE_STATUS_SCHEMA_VERSION = '2026-08-work-record-repair-recovery-bundle-lifecycle-status-v1';
