...
function evidenceBase(request, capturedAt) {
  return {
    ...
    evidence_dimensions: request.evidence_dimensions,
    evidence_factors: request.evidence_factors,
    notes: request.notes,
...
export function captureBrowserEvidenceRequest(requestInput, {
  ...
  try {
    ...
    return {
      ...
      evidence_dimensions: stringArray(objectValue(requestInput).evidence_dimensions),
      evidence_factors: stringArray(objectValue(requestInput).evidence_factors),
