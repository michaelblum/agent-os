...
const target = params.get('target') || 'canvas-inspector'
...
button.setAttribute('data-aos-ref', 'canvas-inspector:annotation-action')
button.setAttribute('data-aos-surface', 'canvas-inspector')
...
declareManifest({
  name: 'canvas-inspector-annotation-action-control',
  title: label,
  accepts: [],
  emits: ['canvas.send'],
})
