...
export type {
  ...
  SceneJsonValue,
  SceneLease,
  SceneNativeEffectProgram,
  SceneNativeEffectGLSLProgram,
  SceneNativeEffectProgramMaterial,
  SceneNativeEffectProgramNode,
  SceneNativeEffectProgramParameter,
  SceneNativeEffectProgramReference,
