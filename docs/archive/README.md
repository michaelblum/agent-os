...
The pre-remodel project state is preserved on this GitHub branch:

`archive/pre-foreman-team-remodel-2026-06-07`

Snapshot commit:

`36c9b37080c420f47ea8e1fa8c5396201c41f2a5`

That commit is the project state before the broader `.docks` remodel began,
when `.docks/foreman`, `.docks/gdi`, `.docks/operator`, and `.docks/harness`
still existed as separate dock surfaces.
