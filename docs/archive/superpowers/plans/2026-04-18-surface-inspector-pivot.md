...
- `docs/superpowers/specs/2026-04-18-surface-inspector-object-marks-design.md`
- `docs/superpowers/plans/2026-04-18-surface-inspector-object-marks.md`

## Summary

Narrow the in-flight surface-inspector object-marks work to primitive-only object markers. Split live visual reference out into a separate primitive, `aos see stream`, instead of embedding thumbnail/icon/capture logic into mark payloads.
...
- gives surface-inspector a clean way to draw live display-feed backgrounds behind object markers
...
For surface-inspector, this means one low-profile stream per display, rendered as faint moving display backgrounds beneath the minimap overlays and object markers.
...
- richer surface-inspector backgrounds
