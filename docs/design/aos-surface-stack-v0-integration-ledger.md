...
| #122, #223 | `docs/design/work-cards/toolkit-surface-interaction-decision-tree-v0.md` | `docs/recipes/aos-surface-interaction-decision-tree.md` is the routing recipe for DOM, toolkit panel/windowing, StageAffordance, passive stage layers, full WebViews, private renderers, and daemon primitives. |
