...
- required_start_ref:
  `origin/gdi/perceive-semantic-target-canonical-cutover-v0` at
  `92eb489b373d3c7f4f27b6937b3a340bcbaf47ab`
- expected output branch:
  `gdi/perceive-semantic-target-canonical-cutover-v0`
...
- Original card:
  `docs/design/work-cards/gdi-perceive-semantic-target-canonical-cutover-v0.md`
...
git rev-parse HEAD origin/main origin/gdi/perceive-semantic-target-canonical-cutover-v0
...
`.docks/gdi/scripts/human-needed-tcc-reset`, stop with `human_needed`, and after
