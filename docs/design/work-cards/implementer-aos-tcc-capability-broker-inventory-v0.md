# Implementer Work Card: AOS TCC Capability Broker Inventory V0
...
- Required start ref: current local checkout in `/Users/Michael/Code/agent-os`, branch `implementer/aos-target-addressed-action-ergonomics-v0`, at or after `aed925ca`.
...
Propose machine-checkable tests/guards for later slices, including:
...
Name the next Implementer slice and its single goal. It should normally be runtime/readiness extraction unless the inventory reveals a prerequisite primitive design slice.
...
- Do not edit Swift, JS, Python, shell source, schemas, manifests, tests, or command docs in this slice.
