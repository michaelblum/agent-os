...
- expected output branch:
  `implementer/input-event-v2-native-producer-canonical-emission-v0`
...
- Prior gate-map work card:
  `docs/design/work-cards/implementer-input-event-v2-native-boundary-gate-map-v0.md`
- Native boundary ADR:
...
Foreman owns any native rebuild and manual TCC handoff. Implementer must not run
`./aos dev build`.
