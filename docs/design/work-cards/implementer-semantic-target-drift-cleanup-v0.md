...
Implementer implementation and cleanup round.
...
- expected output branch: `implementer/semantic-target-drift-cleanup-v0`
...
- `docs/design/work-cards/implementer-aos-target-addressed-action-ergonomics-v0.md`
...
Do not mutate GitHub issues in this Implementer round. Instead, draft exact short
