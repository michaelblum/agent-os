...
- branch_from:
  `origin/gdi/agent-ui-target-workbench-semantic-target-cutover-v0` at
...
- expected output:
  update and push `gdi/agent-ui-target-workbench-semantic-target-cutover-v0`
...
- Prior correction card:
  `docs/design/work-cards/gdi-agent-ui-target-workbench-semantic-target-cutover-correction-v0.md`
...
- `AGENTS.md`
- `docs/design/work-cards/gdi-agent-ui-target-workbench-semantic-target-cutover-v0.md`
- `docs/design/work-cards/gdi-agent-ui-target-workbench-semantic-target-cutover-correction-v0.md`
