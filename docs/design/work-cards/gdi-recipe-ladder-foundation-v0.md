# Work Card: GDI Recipe Ladder Foundation V0
...
- Branch/output expectation: create or reuse
  `gdi/recipe-ladder-foundation-v0` from the required start ref. Commit and push
  the GDI branch when verification passes. Do not open or merge a PR; Foreman
...
If live readiness is blocked by TCC/input tap, use the human-needed path above
