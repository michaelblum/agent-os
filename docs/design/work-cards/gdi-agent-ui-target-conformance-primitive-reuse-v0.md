...
- branch_from: `origin/gdi/perceive-semantic-target-canonical-cutover-v0` at
  `eafc02bb0e9505a37370b7820d148da04fc10f8c`
- expected output branch:
  `gdi/agent-ui-target-conformance-primitive-reuse-v0`
...
git rev-parse HEAD
git rev-parse origin/gdi/perceive-semantic-target-canonical-cutover-v0
...
- Keep the test's role as a migration/drift spec. Do not delete its per-shape
  ...
  see `gdi-perceive-semantic-target-canonical-cutover-v0.md`.)
