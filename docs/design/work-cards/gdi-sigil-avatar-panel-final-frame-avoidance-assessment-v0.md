# GDI Work Card: Sigil Avatar Panel Final-Frame Avoidance Assessment V0
...
- `expected_output_branch`: `gdi/sigil-avatar-panel-final-frame-avoidance-assessment-v0`
...
If Sigil renderer or panel code changes, also run the focused adjacent tests GDI
