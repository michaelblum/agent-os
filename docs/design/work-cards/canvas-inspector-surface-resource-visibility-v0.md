...
- `packages/toolkit/components/canvas-inspector/surface-resources.js`; or
- an extension of `packages/toolkit/components/canvas-inspector/tree.js` if the
  logic stays small.
...
- `tests/toolkit/canvas-inspector-surface-resources.test.mjs`;
- `tests/toolkit/canvas-inspector-tree.test.mjs`;
