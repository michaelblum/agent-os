...
- required_start_ref:
  `implementer/post-refactor-real-input-dogfooding-corrections-v0` at `2bd2338`
...
corrections are accepted on `implementer/post-refactor-real-input-dogfooding-corrections-v0`
at `2bd2338`.
...
- Accepted correction card:
  `docs/design/work-cards/implementer-compact-control-record-contract-review-correction-v0.md`
- Accepted id/ref correction card:
  `docs/design/work-cards/implementer-compact-control-record-id-ref-consistency-correction-v0.md`
