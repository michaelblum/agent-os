# Implementer: Sigil Avatar Phase 3 Descriptor Workbench Pass V0
...
- `docs/design/work-cards/implementer-sigil-avatar-phase2-performance-pass-v0.md`
- `docs/design/work-cards/implementer-sigil-avatar-tesseron-child-appearance-correction-v0.md`
