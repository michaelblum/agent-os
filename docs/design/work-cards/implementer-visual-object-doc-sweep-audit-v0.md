# Work Card: implementer-visual-object-doc-sweep-audit-v0
...
- branch_from: current Foreman branch
  `implementer/selection-mode-cursor-ancestor-ladder-v0`
- required_start_ref: `implementer/selection-mode-cursor-ancestor-ladder-v0`
