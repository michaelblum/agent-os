# Implementer Radial Live IPC Cleanup Correction V0
...
- Source artifact: Foreman acceptance pass after folding
  `implementer/aos-do-click-real-input-delivery-latency-v0`.
- Branch/output expectation: start from
  `origin/feat/command-surface-extraction`, create or update
  `implementer/radial-live-ipc-cleanup-correction-v0`, and push it.
...
- expected output branch: `implementer/radial-live-ipc-cleanup-correction-v0`
