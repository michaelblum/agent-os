...
- Transfer kind: Implementer validation / bounded correction round.
...
- Branch/output expectation: start from
  ...
  `implementer/pr378-sigil-mvp-runtime-acceptance-v0`, and push it.
...
- expected output branch: `implementer/pr378-sigil-mvp-runtime-acceptance-v0`
...
- `docs/design/work-cards/implementer-radial-live-ipc-cleanup-correction-v0.md`
