# Work Card: gdi-visual-object-stale-doc-sanitization-v0
...
- `AGENTS.md`
- `docs/design/work-cards/gdi-visual-object-doc-sweep-audit-v0.md`
- `docs/adr/0014-visual-object-descriptor-contract.md`
- `docs/design/visual-object-descriptor-contract-v0.md`
- `docs/dev/reports/aos-visual-object-architecture.md`
- `docs/design/aos-3d-object-graph-platform-contract.md`
- `docs/design/work-cards/gdi-visual-object-phase6-closure-and-next-tracks-v0.md`
...
- `docs/design/work-cards/gdi-visual-object-phase6-*.md`
- `docs/design/work-cards/gdi-sigil-avatar-stellation-*.md`
- `docs/design/work-cards/gdi-sigil-avatar-phase*.md`
- `docs/design/work-cards/gdi-visual-object-phase5-*.md`
