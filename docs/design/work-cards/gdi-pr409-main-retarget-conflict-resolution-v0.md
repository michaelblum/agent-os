# GDI Work Card: Reconcile #409 After Main Retarget
...
- Prior accepted correction: `docs/design/work-cards/gdi-aos-broker-js-composition-correction-v0.md`
...
GDI starts from a fresh context window. Do not assume branch, checkout, daemon, canvas, issue, or prior implementation state. Read and rediscover before editing.

## Branch / Base

- Repo: `/Users/Michael/Code/agent-os`
- Required start ref: `gdi/aos-target-addressed-action-ergonomics-v0`
...
- Expected output: one local reconciliation commit on `gdi/aos-target-addressed-action-ergonomics-v0`.
...
- `docs/design/work-cards/gdi-aos-broker-js-composition-correction-v0.md`
...
git rev-parse HEAD origin/main origin/gdi/aos-target-addressed-action-ergonomics-v0
...
Then stop with `human_needed` and report the blocker to Foreman. Do not retry live checks, reset permissions, open Settings, rebuild native, or route around `./aos` with raw daemon tools.
