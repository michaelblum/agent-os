# GDI Work Card: AOS Visible Surface Cross-Process Audit V0
...
- `expected_output_branch`: `gdi/aos-visible-surface-cross-process-audit-v0`
...
rg -n "visibleSurfaceAudit|nativeWindowServerEntries|CGWindowListCopyWindowInfo|owner_pid|native_window_scope|stale_daemons|aos clean|show audit|windowNumbers" src scripts tests manifests docs/design/work-cards/gdi-aos-visible-surface-orphan-audit-v0.md
```
...
window-server and process metadata internally, but do not make Foreman, GDI, or
