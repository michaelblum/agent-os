# GDI Sigil Status Item Stale Root Recovery V0
...
- Branch/output expectation: start from
  `origin/feat/command-surface-extraction`, create a focused GDI branch, commit
...
=> aos://sigil_gdi_sigil_warm_surface_lifecycle_performance_v0/renderer/index.html?toolkit-root=toolkit_gdi_sigil_warm_surface_lifecycle_performance_v0
```
...
```text
location.href
=> http://127.0.0.1:<port>/sigil_gdi_sigil_warm_surface_lifecycle_performance_v0/renderer/index.html?toolkit-root=toolkit_gdi_sigil_warm_surface_lifecycle_performance_v0

document.body.innerText
=> Unknown content root: sigil_gdi_sigil_warm_surface_lifecycle_performance_v0
...
- `docs/design/work-cards/gdi-experience-runtime-hygiene-correction-v0.md`
- `docs/design/work-cards/gdi-sigil-warm-surface-lifecycle-performance-v0.md`
- `docs/design/work-cards/gdi-test-suite-contract-audit-v0.md`
...
Branch-scoped roots are useful for GDI branches and local worktrees. The bug is
