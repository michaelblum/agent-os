...
- expected output branch: `implementer/sigil-avatar-hit-target-click-drag-correction-v0`
...
with `manual_intervention` and report that exact diagnosis. Do not burn time on ad-hoc
