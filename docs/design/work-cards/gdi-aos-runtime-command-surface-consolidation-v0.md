# GDI Work Card: AOS Runtime Command Surface Consolidation V0
...
- related card to absorb/supersede:
  `docs/design/work-cards/gdi-aos-daemon-unmanaged-owner-guardrail-v0.md`
...
- `expected_output_branch`:
  `gdi/aos-runtime-command-surface-consolidation-v0`
...
`gdi-aos-daemon-unmanaged-owner-guardrail-v0.md`:
