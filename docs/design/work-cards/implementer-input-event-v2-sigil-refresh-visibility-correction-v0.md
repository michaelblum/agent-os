# Implementer Work Card: Input Event V2 Sigil Refresh Visibility Correction V0
...
- Expected output branch:
  `implementer/input-event-v2-sigil-refresh-visibility-correction-v0`.
...
- `docs/design/work-cards/operator-input-event-v2-live-proof-v0.md`
- `docs/design/work-cards/implementer-input-event-v2-sigil-live-proof-correction-v0.md`
