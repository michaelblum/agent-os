# GDI Correction Card: AOS Execution Model Playbook Contract Cleanup V0
...
- `branch_from`: `origin/gdi/aos-execution-model-taxonomy-v0`
- `required_start_ref`: latest `origin/gdi/aos-execution-model-taxonomy-v0`
