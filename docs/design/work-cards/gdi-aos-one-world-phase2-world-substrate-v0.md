# GDI Work Card: AOS One-World Phase 2 — World Substrate V0
...
- Workstream goal contract: `docs/design/aos-surface-world-goal-contract-v0.md`
...
- Phase 1 work card (closed): `docs/design/work-cards/gdi-aos-one-world-phase1-co-location-probe-v0.md`
...
- `branch_from`: `gdi/aos-one-world-phase1-co-location-probe-v0` (set at dispatch)
- `required_start_ref`: set at dispatch — base is the commit closing
  `gdi/aos-one-world-phase1-co-location-probe-v0`
- `expected_output_branch`: `gdi/aos-one-world-phase2-world-substrate-v0`
...
GDI starts from a fresh context window. Do not assume branch, checkout,
...
`gdi-sigil-avatar-panel-resource-contract-migration-v0`).
...
- `docs/design/aos-surface-world-goal-contract-v0.md` (§2 Done conditions,
...
- Sigil-as-content migration: avatar renderer as World entities
  (Phase 5 / `gdi-sigil-avatar-panel-resource-contract-migration-v0`)
