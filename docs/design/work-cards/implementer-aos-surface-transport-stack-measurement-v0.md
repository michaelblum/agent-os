# Implementer Work Card: AOS Surface Transport Stack Measurement V0
...
Implementer implementation and measurement round.

## Branch / Base

- `branch_from`: local `implementer/avatar-compact-surface-ux-v0`
- `required_start_ref`: `8f9fafc8c2b304000ad05135313c802eb68bd569`
- `expected_output_branch`: `implementer/aos-surface-transport-stack-measurement-v0`
