...
- That prompt triggered a known Codex goal-mode repeated completion loop: GDI repeatedly
...
- Follow-up routed:
  ...
  reject repeated-completion-prone one-shot goal prompts before they reach GDI.
