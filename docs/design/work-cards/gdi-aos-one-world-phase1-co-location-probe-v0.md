# GDI Work Card: AOS One-World Phase 1 — Co-location Probe V0
...
- Phase 0 work card (closed): `docs/design/work-cards/gdi-aos-surface-transport-stack-measurement-v0.md`
...
- `required_start_ref`: set at dispatch — base is the commit closing
  `gdi/aos-surface-transport-stack-measurement-v0`
- `expected_output_branch`: `gdi/aos-one-world-phase1-co-location-probe-v0`
...
- `docs/design/aos-surface-world-goal-contract-v0.md` (§5 Phase 1 gate, §3
  invariants)
