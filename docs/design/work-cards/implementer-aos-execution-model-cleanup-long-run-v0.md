# Implementer Work Card: AOS Execution Model Cleanup Long Run V0
...
- Prior work cards:
  - `docs/design/work-cards/implementer-aos-execution-model-taxonomy-v0.md`
  - `docs/design/work-cards/implementer-aos-execution-model-playbook-contract-correction-v0.md`
...
- `required_start_ref`: latest `origin/implementer/aos-execution-model-cleanup-long-run-v0`
...
Then report `manual_intervention`. This long-run card should be able to complete with
