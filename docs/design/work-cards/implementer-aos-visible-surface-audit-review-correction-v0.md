# Implementer Correction Card: AOS Visible Surface Audit Review Correction V0
...
`docs/design/work-cards/implementer-toolkit-panel-live-drag-correction-v0.md`; that
card remains paused.
...
Implementer starts from a fresh context window. Rediscover before editing. Preserve
