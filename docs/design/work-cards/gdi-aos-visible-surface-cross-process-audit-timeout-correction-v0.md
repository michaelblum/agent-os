# GDI Work Card: AOS Visible Surface Cross-Process Audit Timeout Correction V0
...
GDI. Do not classify the duplicate Accessibility UI row alone as stale TCC if
