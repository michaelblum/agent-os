# GDI Work Card: AOS One-World Scheduler Adoption V0
...
- GitHub ledger: #223
- Goal contract: `docs/design/aos-surface-world-goal-contract-v0.md`
...
blocks on repo-mode TCC/input-tap, run the GDI human-needed helper above and
