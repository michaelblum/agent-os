...
Implementer implementation/correction round.

## Branch / Base

- branch_from: `origin/main`
- required_start_ref: `origin/main`
- expected output branch: `implementer/post-refactor-real-input-dogfooding-corrections-v0`
...
- Do not make Implementer self-accept any broader product decision; report ambiguous
...
If live readiness remains blocked, stop with the Implementer TCC helper output instead
