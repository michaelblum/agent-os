...
GDI loop, then prove them deterministically and with a bounded live smoke.
...
- `docs/design/work-cards/gdi-visual-object-phase5-consolidation-v0.md`
...
Cover this as one broad Phase 6 slice. GDI should inspect current code before
