# GDI Work Card: AOS One-World Phase 3 — Surface Migration V0
...
- Phase 2 work card (closed): `docs/design/work-cards/gdi-aos-one-world-phase2-world-substrate-v0.md`
...
- `branch_from`: `gdi/aos-one-world-phase2-world-substrate-v0` (set at dispatch)
- `required_start_ref`: set at dispatch — base is the commit closing
  `gdi/aos-one-world-phase2-world-substrate-v0`
- `expected_output_branch`: `gdi/aos-one-world-phase3-surface-migration-v0`
...
- `docs/design/aos-surface-world-goal-contract-v0.md` (§2.3 Done conditions,
