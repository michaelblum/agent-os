# Implementer Work Card: Integrate Compact Scroll Fix With Snapshot Extraction
...
- `branch_from`: `origin/implementer/radial-compact-real-input-primitives-v0`
- `required_start_ref`: `origin/implementer/radial-compact-real-input-primitives-v0`
- Related branch to integrate: `origin/implementer/sigil-context-menu-record-snapshot-extraction-v0`
- Common base: `origin/implementer/post-refactor-real-input-dogfooding-corrections-v0` at `2bd233845f3575c1d38bd12f3f84a080ca9f79b1`

Do not restart from `origin/main`.

## Source Context

Foreman accepted the Implementer completion report for:

- branch: `implementer/radial-compact-real-input-primitives-v0`
...
- head: `origin/implementer/sigil-context-menu-record-snapshot-extraction-v0`
- head sha: `9160d44d89c0203ae820053eff405acbf91b3c51`
- base: `implementer/post-refactor-real-input-dogfooding-corrections-v0`

Foreman ran:

```bash
git merge-tree $(git merge-base HEAD origin/implementer/sigil-context-menu-record-snapshot-extraction-v0) HEAD origin/implementer/sigil-context-menu-record-snapshot-extraction-v0
```
...
- `apps/sigil/context-menu/snapshot-projection.js` from `origin/implementer/sigil-context-menu-record-snapshot-extraction-v0`
- `tests/renderer/context-menu-snapshot-projection.test.mjs` from `origin/implementer/sigil-context-menu-record-snapshot-extraction-v0`
...
git rev-parse HEAD origin/implementer/radial-compact-real-input-primitives-v0 origin/implementer/sigil-context-menu-record-snapshot-extraction-v0
git merge-base HEAD origin/implementer/sigil-context-menu-record-snapshot-extraction-v0
git merge-tree $(git merge-base HEAD origin/implementer/sigil-context-menu-record-snapshot-extraction-v0) HEAD origin/implementer/sigil-context-menu-record-snapshot-extraction-v0
```
...
1. Start from `origin/implementer/radial-compact-real-input-primitives-v0`.
...
4. Keep the scroll-preserving `mountCompactSurface()` and no-remount `applySnapshot()` behavior from `implementer/radial-compact-real-input-primitives-v0`.
