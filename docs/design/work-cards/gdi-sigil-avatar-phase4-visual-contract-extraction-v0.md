# GDI: Sigil Avatar Phase 4 Visual Contract Extraction V0
...
- `docs/design/work-cards/gdi-sigil-avatar-phase3-descriptor-workbench-pass-v0.md`
...
Live AOS verification is optional for this contract extraction slice unless GDI
