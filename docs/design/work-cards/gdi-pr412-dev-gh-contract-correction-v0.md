# GDI Correction Card: PR #412 Dev GH Contract Alignment
...
- Branch/base:
  - branch_from: `origin/gdi/aos-broker-auto-repair-settlement-v0`
  - required_start_ref: `origin/gdi/aos-broker-auto-repair-settlement-v0`
...
git diff --check HEAD -- scripts/aos-dev-gh.mjs docs/dev/agent-capabilities.json .docks/foreman/dock.json .docks/gdi/dock.json .docks/operator/dock.json tests/dev-workflow-router.sh tests/schemas/aos-agent-capability-manifest-v0.test.mjs tests/schemas/aos-dock-profile-v0.test.mjs docs/api/aos.md docs/agents/issue-tracker.md
