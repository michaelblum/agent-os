# Implementer Work Card: AOS-Native Compact Tab Records v0
...
- branch/output expectation: keep work on this branch unless Implementer's local contract requires an output branch; do not reset to `origin/main`
