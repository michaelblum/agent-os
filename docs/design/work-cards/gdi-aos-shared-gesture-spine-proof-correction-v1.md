# GDI Work Card: AOS Shared Gesture Spine Proof Correction V1
...
- Source work card: `docs/design/work-cards/gdi-aos-shared-gesture-spine-proof-v0.md`
- Restored draft source: `stash@{0}` from
  `gdi/aos-shared-gesture-spine-proof-v0`
...
- `docs/design/work-cards/gdi-aos-shared-gesture-spine-proof-v0.md`
