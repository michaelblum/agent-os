# Implementer Work Card: AOS Runtime Service Input Tap Observability V0
...
- `expected_output_branch`: `implementer/aos-runtime-service-input-tap-observability-v0`
...
- `docs/design/work-cards/implementer-input-tap-stale-daemon-ready-hygiene-v0.md`
- `docs/design/work-cards/implementer-aos-ready-fast-healthy-path-v0.md`
...
Implementer. Do not classify duplicate Accessibility UI rows alone as stale TCC when
