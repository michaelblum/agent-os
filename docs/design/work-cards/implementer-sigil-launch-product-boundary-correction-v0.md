# Work Card: Implementer Sigil Launch Product Boundary Correction V0
...
- Branch/output expectation: continue from
  `origin/implementer/recipe-app-launch-correction-v0`, commit and push the corrected
  Implementer branch. Do not open or merge a PR; Foreman will review.
...
- branch_from: `origin/implementer/recipe-app-launch-correction-v0`
- required_start_ref: `origin/implementer/recipe-app-launch-correction-v0`
...
`origin/implementer/recipe-ladder-foundation-v0`.
...
git rev-parse HEAD origin/implementer/recipe-app-launch-correction-v0
