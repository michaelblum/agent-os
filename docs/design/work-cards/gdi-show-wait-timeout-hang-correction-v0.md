# GDI Show Wait Timeout Hang Correction V0
...
Foreman review of `origin/gdi/sigil-diagnostic-surface-jank-guard-v0` after:
...
- `docs/design/work-cards/gdi-status-item-tracked-lifecycle-regression-correction-v0.md`
