...
- required_start_ref: local branch
  `gdi/post-refactor-real-input-dogfooding-corrections-v0` at `05a904e5`
- expected output branch:
  `gdi/post-refactor-real-input-dogfooding-corrections-v0`

Do not reset to `origin/main` or to
`origin/gdi/post-refactor-real-input-dogfooding-corrections-v0`; the remote
...
- Foreman review input: "Thermo-Nuclear Review -
  gdi/post-refactor-real-input-dogfooding-corrections-v0" against base
  `77cdbdb1`, 10 commits, reviewed at local head `05a904e5`.
- Prior adjacent cards:
  - `docs/design/work-cards/gdi-aos-native-compact-tab-records-v0.md`
  - `docs/design/work-cards/gdi-aos-native-compact-record-primary-smoke-v0.md`
...
- Do not decompose `apps/sigil/context-menu/menu.js` in this correction. That
  ...
  `docs/design/work-cards/gdi-sigil-context-menu-record-snapshot-extraction-v0.md`.
...
adjacent toolkit tests GDI identifies with `rg --files tests/toolkit`.
