# Manual AFK Receipt: live bridge cwd mismatch classifier GDI partial

receipt_bundle_id: manual-afk-2026-05-22-live-bridge-cwd-mismatch-classifier-gdi
...
- branch: `gdi/afk-provider-session-cwd-mismatch-classification-v0`
...
- idempotence_key:
  `manual-afk-live-cwd-mismatch-classifier:gdi:codex:99dd7fb3`
...
- bridge_health:
  - ok: true
  - default_cwd: `/Users/Michael/Code/agent-os/.docks/gdi`
  - driver: `process`
- bridge_ensure:
  - ok: true
  - created: true
...
- broad_query_result: returned the same GDI-shaped 308-record view because the
  bridge defaults the cwd filter to its default cwd when no explicit cwd is
  supplied
- observed_cwd_filter:
  `/sessions?cwd=/Users/Michael/Code/agent-os/.docks/operator&provider=codex`
- observed_current_session:
  `019e4ff5-f628-7e02-b590-4bd9cb85a868`
- observed_current_cwd: `/Users/Michael/Code/agent-os/.docks/operator`
...
- goal: launch one supervised Codex/GDI provider session through the Sigil
...
correction so future live evidence can distinguish "no current GDI session" from
