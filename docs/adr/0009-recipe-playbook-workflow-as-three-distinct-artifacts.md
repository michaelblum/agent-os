...
narrows **Recipe** to source-backed executable procedures. The historical
`docs/recipes/` Markdown files are transitional Guides/SOPs until a directory
migration renames or rehomes them.
