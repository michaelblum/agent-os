...
`docs/design/work-cards/aos-html-workbench-expression-v0.md`, and the default
output is
`docs/design/fixtures/spatial-subject-tree-v0/aos-html-workbench-expression-v0.json`.
