...
- `apps/sigil/studio/index.html`
- `apps/sigil/studio/js/agent-actions.js`
- `apps/sigil/studio/js/chip-menu.js`
- `apps/sigil/studio/js/modal.js`
- `apps/sigil/studio/js/reroll.js`
- `apps/sigil/studio/js/roster.js`
