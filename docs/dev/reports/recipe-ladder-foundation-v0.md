...
- `scripts/aos-recipe.mjs`: recipe engine implementation. It backs the canonical `aos recipe` surface; the old `aos ops` compatibility alias has been retired.
...
- Keep recipe implementation vocabulary recipe-owned in scripts, schemas, generated indexes, tests, and examples.
